...
(function () {
  ...
  console.log(
    "[Mobile Sidebar] Script loaded, viewport:",
  ...
  function initializeMobileSidebar() {
    ...
    if (!sidebarContainer) {
      console.log(
        "[Mobile Sidebar] No sidebar container found, skipping initialization"
      );
      return;
    }
    ...
    hamburgerBtn.style.cssText =
      "display: none; position: fixed; top: 58px; left: 8px; z-index: 10000; background: #14AE5C; color: white; border: none; padding: 12px 16px; border-radius: 5px; font-size: 24px; line-height: 1; cursor: pointer; box-shadow: 0 2px 8px rgba(0,0,0,0.3);";
    ...
    backdrop.style.cssText =
      "display: none; position: fixed; top: 0; left: 0; width: 100vw; height: 100vh; background: rgba(0,0,0,0.5); z-index: 9998;";
    ...
    function toggleSidebar(show) {
      ...
      if (show) {
        ...
        setTimeout(function () {
          ...
          console.log(
            "[Mobile Sidebar] Sidebar styles applied, computed width:",
        ...
        try {
          if (
            sidebar.__vue__ &&
            sidebar.__vue__.$children &&
            sidebar.__vue__.$children[0]
          ) {
