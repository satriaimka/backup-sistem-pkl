...
/* __string_template__e21d2595b9ccfcee4945f07c1e9a90c7 */
class __TwigTemplate_bbe6acab39c704041b3da193c595ebdb extends Template
{
    private $source;
    private $macros = [];
            ...
            > </i>     
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["answerOption"]) {
                    ...
                    yield "                            <!-- Line tag -->
                            ";
                    // line 70
                    yield from                     $this->loadTemplate("answerOptionRow.twig", "__string_template__e21d2595b9ccfcee4945f07c1e9a90c7", 70)->unwrap()->yield(CoreExtension::merge($context, ["activated" =>                     // line 71
...
";
        ...
        if ((($context["first"] ?? null) == false)) {
            ...
            // line 130
            yield "    ";
            yield from             $this->loadTemplate("modals.twig", "__string_template__e21d2595b9ccfcee4945f07c1e9a90c7", 130)->unwrap()->yield($context);
        }
        // line 132
        yield "
<!-- For javascript -->
...
";
    ...
    {
        return "__string_template__e21d2595b9ccfcee4945f07c1e9a90c7";
    }
    ...
    {
        return new Source("", "__string_template__e21d2595b9ccfcee4945f07c1e9a90c7", "");
    }
